...
then
    ...
    wget -q --delete-after "http://127.0.0.1:8080/json.htm?type=command&param=udevice&idx=$1&nvalue=0&svalue=$speed_ping"
    wget -q --delete-after "http://127.0.0.1:8080/json.htm?type=command&param=udevice&idx=$2&nvalue=0&svalue=$speed_upload"
    wget -q --delete-after "http://127.0.0.1:8080/json.htm?type=command&param=udevice&idx=$3&nvalue=0&svalue=$speed_download"
    wget -q --delete-after "http://127.0.0.1:8080/json.htm?type=command&param=udevice&idx=$4&nvalue=0&svalue=$speed_single_upload"
    wget -q --delete-after "http://127.0.0.1:8080/json.htm?type=command&param=udevice&idx=$5&nvalue=0&svalue=$speed_single_download"
fi
}
#
